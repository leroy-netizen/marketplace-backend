      ...
      findOneBy: jest.fn().mockImplementation(({ email }) => {
        if (email === 'existing@example.com') {
          return {
            ...
            name: 'Existing User',
            password: '$2b$10$X/XZFKxEkQzL9DULlKSYXO5CLS.xZGzb7pT5.QJjUHQFPe4hPjlIe', // hashed 'password123'
            role: 'buyer'
          };
        }
        return null;
...
// Mock bcrypt
jest.mock('bcrypt', () => ({
  compare: jest.fn().mockImplementation((password, hash) => password === 'password123'),
